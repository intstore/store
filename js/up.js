...
function otherStyle(cur_sel){
  if(pdMenu[0] > 1){	  //pdMenu[curPage_num-1] 固定2栏目
	...
	if(sessionStorage.arr != undefined){  //news_all页面 有执行 搜索,并返回了 
		var serLists = sessionStorage.arr;  //读取 搜索结果 数组
